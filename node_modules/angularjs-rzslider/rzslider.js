...
.directive('rzslider', ['Slider', function(Slider)
{
  return {
    ...
    template:   '<span class="bar"></span>' + // 0 The slider bar
                ...
                '<span class="bubble limit-floor"></span>' + // 4 Floor label
                '<span class="bubble limit-ceiling"></span>' + // 5 Ceiling label
                '<span class="bubble"></span>' + // 6 Label above left slider handle
                '<span class="bubble" ng-model="distribution.price"></span>' + // 7 Label above right slider handle
                '<span class="bubble" ng-model="distribution.price"></span>', // 8 Range label when the slider handles are close ex. 15 - 17
